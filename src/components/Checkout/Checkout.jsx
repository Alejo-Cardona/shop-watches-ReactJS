...
const Checkout = ({ item }) => {
    ...
    const total = (count * item.precio) + (count * precioEnvio)
    ...
    // Crear orden y enviarla al servidor
    ...
    return(
        <>
            <section className="d-grid master_container container border border-black border-opacity-25 rounded col-10 col-md-6 mb-4" id="check-id">
                <label className="text-center mt-3">Si llevas mas de 3 unidades el envio es <span className="text-success fw-bold">Gratias!</span></label>
            ...
            <section className="d-grid master_container container border border-black border-opacity-25 rounded col-10 col-md-6 mt-3 mb-5">
                <h4 className="col-12 text-center mt-5">Subtotal: <span className="fw-normal fs-4 ms-2">{`$${count * item.precio}`}</span></h4>
                ...
                <div className="total__info rounded-top row mt-4">
                    <div className="col-6 text-center ">
                        <h4 className="mt-3 fs-3">Total: <span className="fw-normal fs-3 ms-2">{`$${total}`}</span></h4>
                    </div>
                    <div className="col-6 d-flex justify-content-center align-items-center">
                        <Button variant="success" size="lg" onClick={handleSendOrder}>Realizar Compra</Button>
                    </div>
                </div>
            </section>
        </>
